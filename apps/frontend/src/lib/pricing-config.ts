...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out Home Grown AI Workers',
    ...
    features: [
      ...
      '1 concurrent run',
      'Basic Mode - Core Home Grown AI experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Home Grown AI Workers with custom Knowledge, Tools & Integrations',
      ...
      'Home Grown AI Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Home Grown AI Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Home Grown AI Workers with custom Knowledge, Tools & Integrations',
