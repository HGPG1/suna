              ...
              <div className="flex flex-col items-center justify-center gap-6 pt-12 max-w-4xl mx-auto pb-16">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                  <Button asChild size="lg" className="text-base h-14 w-48 rounded-full px-8">
                    <a href="mailto:support@homegrownpropertygroup.com">
                ...
                <p className="text-sm text-muted-foreground">
                  Or email us directly at <a href="mailto:support@homegrownpropertygroup.com" className="text-primary hover:underline font-medium">support@homegrownpropertygroup.com</a>
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    >
                      support@homegrownpropertygroup.com
                    </a>
                  </div>
                </div>
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@homegrownpropertygroup.com" className="text-primary hover:underline font-medium">
                      Contact us
                    </a>
                  </div>
                </div>
          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                <FAQItem
                  question="What is Home Grown AI?"
                  answer="Home Grown AI is a generalist AI worker that can perform real-world tasks on your behalf. Unlike traditional AI assistants, Home Grown AI can actually take action across your apps, automate workflows, and handle complex multi-step tasks autonomously."
                />
                <FAQItem
                  question="How can Home Grown AI help me?"
                  answer="Home Grown AI can automate repetitive tasks, manage your workflows, interact with web services, process data, create content, and coordinate complex operations across multiple platforms. Simply tell Home Grown AI what you need done, and it handles the execution from start to finish."
                />
                <FAQItem
                  question="How is Home Grown AI different from other AI platforms?"
                  answer="While most AI platforms only provide information or suggestions, Home Grown AI actually performs real-world tasks. It can browse the web, interact with APIs, manage files, execute commands, and integrate with your existing tools to complete tasks autonomously—not just tell you how to do them."
                />
                <FAQItem
                  question="Can Home Grown AI connect to my apps?"
                  answer="Yes! Home Grown AI can connect to thousands of apps and services through integrations. It can interact with your tools, APIs, databases, and workflows to automate tasks across your entire tech stack. You control which apps and services Home Grown AI can access."
                />
                <FAQItem
                  question="How do I request a new feature?"
                  answer={
                    <>
                      We love feature requests! Email us at <a href="mailto:support@homegrownpropertygroup.com" className="text-primary hover:underline font-medium">support@homegrownpropertygroup.com</a> with details about what you'd like to see and how it would help you. We carefully review all suggestions and prioritize features based on user feedback for our product roadmap.
                    </>
                  }
                />
                <FAQItem
                  ...
                  answer={
                    <>
                      If you encounter a bug, please email <a href="mailto:support@homegrownpropertygroup.com" className="text-primary hover:underline font-medium">support@homegrownpropertygroup.com</a> with a detailed description of the issue, steps to reproduce it, and any error messages you're seeing. Screenshots or screen recordings are extremely helpful. We'll investigate and work on a fix promptly.
                    </>
                  }
                />
                <FAQItem
                  ...
                  answer={
                    <>
                      If your credits don't appear after payment, contact <a href="mailto:support@homegrownpropertygroup.com" className="text-primary hover:underline font-medium">support@homegrownpropertygroup.com</a> immediately. We prioritize billing and credit issues for all users regardless of tier and will resolve this as quickly as possible, typically within a few hours during business days.
                    </>
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Our terms and conditions for using Home Grown AI services, including user responsibilities and service limitations.
                    </p>
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Company information and legal details about Home Grown AI, including contact information and registration.
                    </p>
