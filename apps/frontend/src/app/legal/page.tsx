                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Home Grown AI is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY HOME GROWN AI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE HOME GROWN AI
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to Home Grown AI, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the Home Grown AI website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the Home Grown AI platform and all related
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        Home Grown AI is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the Home Grown AI Public
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All Home Grown AI logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE HOME GROWN AI WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        HOME GROWN AI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> Home Grown AI, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at Home Grown AI in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Home Grown AI does not collect biometric or identifying
