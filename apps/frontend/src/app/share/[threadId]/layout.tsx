...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Home Grown AI',
    description: 'Replay this Worker conversation on Home Grown AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Home Grown AI';
    const description =
      projectData.description ||
      'Replay this Worker conversation on Home Grown AI';
