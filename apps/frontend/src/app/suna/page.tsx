...
export const metadata: Metadata = {
  title: 'Suna is now Home Grown AI | Home Grown AI - Open Source AI Worker',
  description: 'Suna has rebranded to Home Grown AI. Home Grown AI (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'Home Grown AI',
    'Suna AI',
  ...
  openGraph: {
    title: 'Suna is now Home Grown AI',
    description: 'Home Grown AI (formerly Suna) - Same powerful open source AI worker, new name.',
    type: 'website',
    url: 'https://www.kortix.com/suna',
    siteName: 'Home Grown AI',
    images: [
      {
        url: '/banner.png',
        width: 1200,
        height: 630,
        alt: 'Home Grown AI - Formerly Suna',
      },
    ],
  },
  twitter: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'Home Grown AI',
            alternateName: ['Suna', 'Home Grown AI', 'Suna AI'],
            ...
            description:
              'Home Grown AI (formerly known as Suna) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Suna is now Home Grown AI',
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Suna to Home Grown AI</p>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. Home Grown AI is the evolution of Suna — the same open
              ...
              Suna", or "Home Grown AI" — this is the official continuation of the Suna project under
              the Home Grown AI brand.
            </p>
          </div>
        </div>
      </main>
